...
useRouteMatch gives you access to the match property without rendering a <Route> component. It matches the URL just like a Route would and it accepts an exact , strict , path and sensitive options just like a <Route>

2. How would you explain form validation to someone who has never programmed before?

Validation is like signing an legal document, you want to check if all the clauses or inputs are correct before signing off on it.

3. In 1-2 sentences, define end to end testing.

End to end testing is a testing technique to test the flow of an application right from the start to finish is behaving as expected.
